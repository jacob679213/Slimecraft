    ...
    public void paintComponent(Graphics g) {
        ...
        for (Slime slime : slimes) {
            ...
            for(Virus virus : viruses){
                if(slime.collide(virus)){
                    int x = (int) (Math.random() * 20);
                    int y = (int) (Math.random() * 20);
                    
                    Virus temp1 = new Virus(slime.getX(), slime.getY());
                    viruses.add(temp1);
                    sprites.add(temp1);
                    Virus temp2 = new Virus(slime.getX()+x, slime.getY()+y);
                    viruses.add(temp2);
                    sprites.add(temp2);
                    Virus temp3 = new Virus(slime.getX()-y, slime.getY()-y);
                    viruses.add(temp3);
                    sprites.add(temp3);
